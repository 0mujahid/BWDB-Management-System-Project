...
public class Package1 extends JFrame {
    ...
    public Package1(Connection connection) {
        this.connection = connection;

        // JFrame settings
        setTitle("Package 1 Input Form");
    ...
    private void insertData() {
        try {
            ...
            String query = "INSERT INTO Package_1(packageNo, dailyMadeBlocks, dailyUsedMachines, rccCost) VALUES (?, ?, ?, ?)";
    ...
    public void Package_1() {
        this.setVisible(true);
    }

    // Stub method for view (implement if needed)
    public void viewPackage1() {

        String query = "SELECT * FROM Package_1";
